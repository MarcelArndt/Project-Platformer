...
export class Tileset{
    ...
    draw(cameraPos){
        this.tileArray.forEach(tile => {
          ctx.drawImage(this.image, tile.tilePos[0], tile.tilePos[1],this.tilesize, this.tilesize, tile.inGamePos[0] - cameraPos[0], tile.inGamePos[1] - cameraPos[1], this.tilesize + 0.5, this.tilesize + 0.5)
        });
    }
}